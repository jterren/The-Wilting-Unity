...
public class Rounds : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MinX = (float)(this.transform.position.x - 12);
        MaxX = (float)(this.transform.position.x + 12);
        MinY = (float)(this.transform.position.y - 12);
        MaxY = (float)(this.transform.position.y + 12);
    }
    ...
    void Update()
    {
        ...
        {
            if (RoundStart == false && Input.GetKey(KeyCode.E))
            {
                if (arrowNeed == false)
                {
